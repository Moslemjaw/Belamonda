export const treatmentCategories = [
  { id: "laser", nameEn: "Laser Services", nameAr: "خدمات الليزر" },
  { id: "injectables", nameEn: "Injectables", nameAr: "الحقن" },
  { id: "skincare", nameEn: "Skin Care", nameAr: "العناية بالبشرة" },
  { id: "beauty", nameEn: "Beauty Enhancements", nameAr: "التحسينات التجميلية" },
  { id: "body", nameEn: "Body & Slimming", nameAr: "الجسم والتخسيس" },
  { id: "dental", nameEn: "Dental Services", nameAr: "خدمات الأسنان" },
  { id: "medical", nameEn: "Medical & Meditation", nameAr: "الطب والتأمل" }
];

export type Clinic = { id: string; nameEn: string; nameAr: string };

export const clinics: Clinic[] = [
  { id: "salmiya", nameEn: "Belamonda Salmiya", nameAr: "بيلاموندو السالمية" },
  { id: "hawally", nameEn: "Belamonda Hawally", nameAr: "بيلاموندو حولي" },
  { id: "jabriya", nameEn: "Belamonda Jabriya", nameAr: "بيلاموندو الجابرية" },
  { id: "farwaniya", nameEn: "Belamonda Farwaniya", nameAr: "بيلاموندو الفروانية" },
];
