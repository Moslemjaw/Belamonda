...
walletRouter.post("/cs/deduct", authRequired, requireRole(["cs", "admin"]), async (req, res, next) => {
  try {
...
walletRouter.post("/admin/adjust", authRequired, requireRole(["admin"]), async (req, res, next) => {
  try {
